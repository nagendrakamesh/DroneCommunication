...
(function($) {
    function FlightIndicator(placeholder, type, options) {
        ...
        var settings = $.extend({
            ...
            pressure: 1000,
            showBox: true,
            img_directory: 'static/flight-indicators/img/'
        }, options);
        ...
        // Creation of the instrument
        placeholder.each(function () {
            var imgDirectory = settings.img_directory; // Store img_directory in a variable

            switch (type) {
                case 'heading':
                    $(this).html('<div class="instrument heading"><img src="' + imgDirectory + 'fi_box.svg" class="background box" alt="" /><div class="heading box"><img src="' + imgDirectory + 'heading_yaw.svg" class="box" alt="" /></div><div class="mechanics box"><img src="' + imgDirectory + 'heading_mechanics.svg" class="box" alt="" /><img src="' + imgDirectory + 'fi_circle.svg" class="box" alt="" /></div></div>');
                    _setHeading(settings.heading);
                    break;
				case 'altimeter':
					$(this).html('<div class="instrument altimeter"><img src="' + imgDirectory + 'fi_box.svg" class="background box" alt="" /><div class="pressure box"><img src="' + imgDirectory + 'altitude_pressure.svg" class="box" alt="" /></div><img src="' + imgDirectory + 'altitude_ticks.svg" class="box" alt="" /><div class="needleSmall box"><img src="' + imgDirectory + 'fi_needle_small.svg" class="box" alt="" /></div><div class="needle box"><img src="' + imgDirectory + 'fi_needle.svg" class="box" alt="" /></div><div class="mechanics box"><img src="' + imgDirectory + 'fi_circle.svg" class="box" alt="" /></div></div>');
					_setAltitude(settings.altitude);
					_setPressure(settings.pressure);
					break;
			
				default:
					// Default case (possibly for attitude)
					$(this).html('<div class="instrument attitude"><img src="' + imgDirectory + 'fi_box.svg" class="background box" alt="" /><div class="roll box"><img src="' + imgDirectory + 'horizon_back.svg" class="box" alt="" /><div class="pitch box"><img src="' + imgDirectory + 'horizon_ball.svg" class="box" alt="" /></div><img src="' + imgDirectory + 'horizon_circle.svg" class="box" alt="" /></div><div class="mechanics box"><img src="' + imgDirectory + 'horizon_mechanics.svg" class="box" alt="" /><img src="' + imgDirectory + 'fi_circle.svg" class="box" alt="" /></div></div>');
					_setRoll(settings.roll);
					_setPitch(settings.pitch);
                // Add cases for other instrument types here
            }
